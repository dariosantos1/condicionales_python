...
if texto_1 > texto_2 :
    print ("El texto_1 es mayor al texto_2")
elif texto_1 == texto_2 :
    print ("Ambos textos son iguales")
else :
    print ("el texto_1 es menor al texto_2")
...
# Respuesta : Texto_2 es mayor a Texto_1 porque la primera letra del "texto_2" 7 es "S" y la primera letra del "texto_1" 5 es "C", por ende S es mayor a C